...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_60_ansi(
        ...
        _______, _______, _______,   _______, KC_PGUP, _______, _______, _______, KC_UP,  _______, KC_PSCR, KC_F15, KC_HOME, KC_END,
        MO(2),    _______, KC_MPLY, _______, KC_PGDN, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_F13,  KC_F14,          _______,
